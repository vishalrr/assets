...
$('.backLink').click(function(){
    ...
    $('.dlt').click(function(){
        ...
        var action= $(this).attr('action');
         ...
         $('.user_type').attr('data-userid',type);
    ...
    $('.deleteaction').click(function(){
        ...
        var type = $('.user_type').attr('data-userid');
        ...
        if(data.trim()!='')
        {
            ...
            {  
             if(del_tbl=='users')
              {                    
                  if(type == '1'){
                    window.location.href=base+'admin/influencer-users';
                  }else{
                    window.location.href=base+'admin/brands-users';
                  }   
